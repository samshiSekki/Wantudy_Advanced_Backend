...
public class QUser extends EntityPathBase<User> {
    ...
    private static final long serialVersionUID = -408945881L;

    public static final QUser user = new QUser("user");

    public final BooleanPath applicationState = createBoolean("applicationState");
    ...
    public final BooleanPath profileState = createBoolean("profileState");
