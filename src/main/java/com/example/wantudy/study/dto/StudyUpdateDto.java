...
public class StudyUpdateDto {
    ...
    @ApiModelProperty(value = "스터디 상세 설명", required = false, example = "토플 자격증을 공부하는 스터디")
    private String description;

    @ApiModelProperty(value = "스터디 난이도", required = false, example = "상")
    ...
    @ApiModelProperty(value = "스터디 모집 인원", required = false, example = "5")
    ...
    @ApiModelProperty(value = "스터디 1차 카테고리", required = false)
    private String parentCategory;

    @ApiModelProperty(value = "스터디 2차 카테고리", required = false, dataType = "List")
    private List<String> categories = new ArrayList<>();

    @ApiModelProperty(value = "희망 시간대", required = false, dataType = "List")
    private List<String> desiredTime = new ArrayList<>();

    @ApiModelProperty(value = "신청서 필수 항목", required = false, dataType = "List")
